...
import youtube_dl
#GUNAKAN BOT DENGAN BIJAK,,,TAK JITAK KLO NAKAL HHH*** Edit v 11,5
#=============
...
km = LineClient("tegarbot2@yahoo.com","putriku75")
...
kb = LineClient("tegarbot3@yahoo.com","putriku75")
...
kn = LineClient("tegarbot4@yahoo.com","putriku75")
...
ko = LineClient("inakinik5@yahoo.com","botline1")
...
kw = LineClient("inakinik6@yahoo.com","botline1")
...
ke = LineClient("tegarbot@yahoo.com","putriku75")
...
ky = LineClient("riniutami87@yahoo.com","putriku75")
...
sw = LineClient("tegarbot11@yahoo.com","putriku75")
...
print("TOLONG GUNAKAN BOTS DENGAN BIJAK")

poll = LinePoll(cl)
call = cl
creator = ["u8a1e16bcff6c5468a076fc6c4e043daf"]
owner = ["u8a1e16bcff6c5468a076fc6c4e043daf"]
admin =["u8a1e16bcff6c5468a076fc6c4e043daf"]
staff = ["u8a1e16bcff6c5468a076fc6c4e043daf"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
...
wait = {
    ...
    "ghostOn":True,
    "mention":"Ciee Lagi ngintip tikungan yee..! gabung sini 😊",
    "Respontag":"Idih tag-teg kalo penting VC aja langsung",
...
def bot(op):
    ...
    try:
                    ...
                    try:
                        if ki.getGroup(op.param1).preventedJoinByTicket == False:
                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                ...
                                sx.cancelGroupInvitation(op.param1,[op.param2])
        ...
        if op.type == 5:
            print ("[ 5 ] SELFBOT-BY:TERX-BOTS AUTO BLOCK")
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                kn.kickoutFromGroup(op.param1,[op.param2])
                                kn.cancelGroupInvitation(op.param1,[op.param2]) #
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                ky.cancelGroupInvitation(op.param1,[op.param2])
            ...
            if cctv['cyduk'][op.param1]==True:
                if op.param1 in cctv['point']:
                    ...
                    if Name in cctv['sidermem'][op.param1]:
                        ...
                        image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus #JIKA MAU SIDER TANPA KLUAR FOTO,,,YG INI KASIH PAGAR...TERX-BOTS
                        cl.sendImageWithURL(op.param1, image)                        
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan anggota bot RERX-BOTX")
#ADD STAFF
                 if msg._from in admin:
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 TYPE: SELFBOT ANTIJS 」\n")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for group in saya:
                                   cl.sendMessage(group,"[ SELFBOT-BY:TERX ]\n" + str(pesan))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "Yess tunggu sebentar...")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"SELFBOT-BY:TERX\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "Selamat tinggall lur..maafin yee jika slama kami dimari banyak salah,,,")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
                                        km.leaveGroup(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                ki.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kk.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kc.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                km.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kb.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kn.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                ko.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                kw.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                ke.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))
                                get_profile_time_start = time.time()
                                get_profile = cl.getProfile()
                                get_profile_time = time.time() - get_profile_time_start
                                ky.sendMessage(msg.to, "Speed NgaciiiR\n%.10f detik" % (get_profile_time/3))

                        elif cmd == "speed" or cmd == "sp":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "NgaciiiR...")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               ki.sendMessage(msg.to, "NgaciiiR...")
                               elapsed_time = time.time() - start
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Bots:
                                       try:
                                           kb.kickoutFromGroup(msg.to, [target]) #tambah kb
                          ...
                          if msg._from in admin:
                           if msg.toType == 2:
                            ...
                            if msg._from in admin:
                                ...
                                targets.remove(mid)
                                if targets == []:
                                    cl.sendText(msg.to,"TETX-BOTS KICK OUT BYE")
                                else:
                                    for target in targets:
                                      if target not in Bots:
                                        try:
