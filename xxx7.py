...
"RATA GAK RATA\n" 
"YANG PENTING ANU\n"
"AYO TANGKIS KLO BISA\n"
"━━━━━━━━━━━━━━\n"
	"BOT LO BOT APAAN SIH\n"
	"KO CUMA BISA NONTON\n"
	"IDIH MENANG NAMA DOANG\n"
	"MENANG SEREM DOAN BOTS LO\n"
"━━━━━━━━━━━━━━\n"
	"KO DIEM AJE LOOO\n"
	"AYO LAWAN KAMI..\n"
	" MASA CUMA MLONGO\n"
...
"━━━━━━━━━━━━━━\n"        
"TERX-BOTS KILER\n"
"HADOOOH HABIS DEH ROOM LO\n" 
"T E R X -B O T S")
                               kc.sendMessage(msg.to,
">>>JANGAN BAPER YEE...>><\nKLO KALIAN DENDAM CARI KAMI\n<<<<<<<<<>>\nhttp://line.me/ti/p/~gerhanaselatan\nhttp://line.me/ti/p/~cyberbot11")
                        ...
                        elif cmd == "terxbot" or cmd == "trbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[TERX-BOTS].")
                               elapsed_time = time.time()
                               ki.sendMessage(msg.to, "╚ ☆STAY☆╗\n╚BOSS╮╗".format(str(elapsed_time)))
                               kk.sendMessage(msg.to, "╚☆STAY☆╗\n╚BOSS╮╗".format(str(elapsed_time)))
                               kc.sendMessage(msg.to, "╚☆STAY☆╗\n╚BOSS╮╗".format(str(elapsed_time)))
                               sw.sendMessage(msg.to, "[SIAP]")
                               cl.sendMessage(msg.to, "╚☆AMANKAN-☆╗\n╚BOSS☆╮╗")
...
">>>JANGAN BAPER YEE...>><\nKLO KALIAN DENDAM CARI KAMI\n<<<<<<<<<>>\nhttp://line.me/ti/p/~gerhanaselatan\nhttp://line.me/ti/p/~cyberbot11")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "🔑[TERX-BOT]\n\n༎⎑  ༓Get Profile\n   %.10f\n༎⎑  ༓Get Contact\n   %.10f\n ༎⎑  ༓Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                        ...
                        elif 'T pro ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('T pro ','')
                              if spl == 'on':
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Desah","Tag","Assalamualaikum","Pagi","Siang","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                             cl.sendMessage(msg.to,"───TERX-BOTS───\nOPEN ORDER\n────────\nSELFBOT ONLY\nSELFBOT + 4 AKUN\n➣1 AKUN UTAMA\n1 AKUN UTAM+ 2 ASIST\n1 AKUN UTAMA+ 3 UTAMA\n1 AKUN UTAMA+ 4 ASIST\n1 UTAMA + 5 ASIST\nSCRIPT APA ADANYA\n──────────────\n  CREATOR\nline.me/ti/p/~gerhanaselatan\nSELFBOT PROTECT-KICKER\n────────────")
                             msg.contentType = 13
                             msg.contentMetadata = {'mid': admin}
                             tanya = msg.text.replace("promo ","")
                             jawab = ("──TERX-BOTS──\nOPEN ORDER\n───┅┅───\nSELFBOT ONLY\nSELFBOT +4 AKUN\n1 KUN UTAMA\n1 AKUN UTAMA+ 2 ᴀꜱɪꜱᴛ\n1 AKUN UTAMA + 3 ASIST\n1 AKUNNUTAMA + 4 ASIST\n1 AKUN UTAMA + 5 ASIST\nSCRIPT APA ADNYA\n\n─────────────\n CREATOR \nline.me/ti/p/~gerhanaselatan\nSELFBOT PROTECT -KICKER\n────────")
                             jawaban = random.choice(jawab)
                             tts = gTTS(text=jawaban, lang='id')
                             tts.save('tts.mp3')
                             cl.sendAudio(msg.to,'tts.mp3')
                             cl.sendMessage(msg)         
                             cl.sendMessage(msg.to,"Jika Anda Berminat Langsung Hubungi Kami 😊")
